...
extern double gsl_complex_arg (gsl_complex z); /* return arg(z), -pi< arg(z) <=+pi */
extern double gsl_complex_abs (gsl_complex z);   /* return |z|   */
extern double gsl_complex_abs2 (gsl_complex z);  /* return |z|^2 */
extern double gsl_complex_logabs (gsl_complex z); /* return log|z| */
